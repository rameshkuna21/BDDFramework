...
public class StepDefinitions {
	...
	@Then("user validate URL to be {string}")
	public void user_validate_url_to_be(String expURL) {
...
//| username | password | Confirm password| Fullname| Email | captcha |
	...
	Thread.sleep(3000);
	driver.findElement(By.xpath("//input[@name='email_add']")).sendKeys(allData.get(0).get("Email"));
	Thread.sleep(3000);
